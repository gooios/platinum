...
bool AppInit2(int argc, char* argv[])
{
    ...
    if (mapArgs.count("-?") || mapArgs.count("--help"))
    {
        string strUsage = string() +
          _("PlCoin version") + " " + FormatFullVersion() + "\n\n" +
          _("Usage:") + "\t\t\t\t\t\t\t\t\t\t\n" +
            "  plcoind [options]                   \t  " + "\n" +
            "  plcoind [options] <command> [params]\t  " + _("Send command to -server or ppcoind") + "\n" +
            "  plcoind [options] help              \t\t  " + _("List commands") + "\n" +
            "  plcoind [options] help <command>    \t\t  " + _("Get help for a command") + "\n" +
          _("Options:") + "\n" +
            ...
            "  -port=<port>     \t\t  " + _("Listen for connections on <port> (default: 10126 or testnet: 10125)") + "\n" +
            ...
            "  -rpcport=<port>  \t\t  " + _("Listen for JSON-RPC connections on <port> (default: 10126)") + "\n" +
